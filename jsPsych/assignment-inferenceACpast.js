    ...
    trial(display_element, trial) {
      ...
      let new_html = `
        <div style="background:${
          ...
          <div style="display:flex; justify-content:space-around; align-items:flex-end; height:400px;">
            <div style="position:relative; width:100px; height:100%; background:${
              trial.bg_color
            };">
              <div style="position:absolute; bottom:0; width:100%; height:${final_left}px; background:${
        trial.left_color
      };"></div>
            </div>
            <div style="position:relative; width:100px; height:100%; background:${
              ...
              <div style="position:absolute; bottom:0; width:100%; height:${final_right}px; background:${
        trial.right_color
      };"></div>
            </div>
          </div>
